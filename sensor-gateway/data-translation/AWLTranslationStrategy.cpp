...
DataFlow::Intensity const
DataTranslation::AWLTranslationStrategy::convertIntensityToSNR(DataFlow::Intensity const& intensity) noexcept {
    Intensity const snr = ((intensity / 1024) / 2.0) - 21; // w+f
    return snr;
}
