...
TEST_F(SensorAccessLinkErrorTest,
    ...
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::EMERGENCY);
    auto closeConnectionIsRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(closeConnectionIsRequired);
}
TEST_F(SensorAccessLinkErrorTest, given_anErrorWithAlertSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::ALERT);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithCriticalSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::CRITICAL);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithErrorSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::ERROR);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithWarningSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::WARNING);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithNoticeSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::NOTICE);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithInfoSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::INFO);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}

TEST_F(SensorAccessLinkErrorTest, given_anErrorWithDebugSeverityLevel_when_askedIfResumeCommunicationIsRequired_then_returnsTrue) {
    auto sensorAccessLinkError = createArbitrarySensorAccessLinkErrorWithSeverity(Severity::DEBUG);
    auto isResumeCommunicationRequired = sensorAccessLinkError.isResumeCommunicationRequired();
    ASSERT_FALSE(isResumeCommunicationRequired);
}
